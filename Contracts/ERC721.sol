...
contract ERC721 is IERC721, IERC721Metadata, Access, Sign, DynamicPrice {
    ...
    function ownerOf (uint id) public view returns (address) {
        ...
        return DID(iProxy.addrs(3)).addressData(address(this), address(0), id);

    }

    function getApproved (uint id) public view returns (address) {

        return DID(iProxy.addrs(3)).addressData(address(this), address(1), id);
    ...
    function approve (address to, uint id) external {
        ...
        DID(iProxy.addrs(3)).updateAddress(address(this), address(1), id, to);
    ...
    function transferFrom (address from, address to, uint id) public {
        ...
        unchecked {
            ...
            iDID.updateAddress(address(this), address(1), id, address(0));       //重置授权
    ...
    function transfer (address from, address to, uint id) private {
        ...
        unchecked {
            ...
            iDID.updateAddress(address(this), address(0), id, to);               //更新NFT持有者
